...
% Comment out this li ne if you don't set IEEEtran in \bibliographystyle{}
...
% \input{chapters/3-narrow-rev-termination}
% \input{chapters/4-broad-rev-termination}
% \input{chapters/5-conclusion}

\input{chapters/3-informal-proof}
\input{chapters/4-formal-proof}
\input{chapters/5-conclusion}
